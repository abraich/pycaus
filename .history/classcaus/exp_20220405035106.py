    ...
    def run(self):
        ...
        for wd_para in self.list_wd_param:
            ...
            for exp in range(self.num_exp):
                ...
                df_results, dic_fig, d_all = Bench.evall_all_bench(mode=self.mode)
                ...
                dt0 = d_all['dt0']
                dt1 = d_all['dt1']
                pehe_l_exp.append(pehe)
                dt0_l_exp.append(dt0)
                dt1_l_exp.append(dt1)
            ...
            pehe_l.append(pehe_l_exp)
            dt0_l.append(dt0_l_exp)
            dt1_l.append(dt1_l_exp)
...
if __name__ == "__main__":
    ...
    list_wd_param = np.arange(0.1, 2., 0.5)
    # create object
