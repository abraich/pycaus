...
import livejson as lj

def save_json(Exp_num, wd_param, wd, model_name, pehe, dt0,dt1,d):
    d[wd_param]={
        '{}'.format(Exp_num):{
            '{}'.format(model_name):{
                'pehe':pehe,
...
dt0 = 0.1
dt1 = 0.1
d = save_json(Exp_num, wd_param, wd, model_name, pehe, dt0,dt1,d)
