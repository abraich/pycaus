...
class MultiApp:
    ...
    def run(self):
        ...
        st.sidebar.info(
            """
            This web [app](https://share.streamlit.io/) is maintained by [Ayoub Abraich]. You can follow me on social media:
             [GitHub](https://github.com/) | [Twitter](https://twitter.com/) | [LinkedIn](https://www.linkedin.com/in/ayoub-abraich/)
        """
        )